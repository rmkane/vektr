...
// ============================================================================
// This script copies converts the object math to array math.
// ============================================================================
...
async function rewriteFiles(directory, fileCallback) {
  try {
    ...
    for (const relativeFile of files) {
      ...
      if (stat.isFile()) {
        ...
        rewriteFiles(file, fileCallback)
      }
    }
  } catch (e) {
...
rewriteFiles(ARRAY_DIR, async function (file) {

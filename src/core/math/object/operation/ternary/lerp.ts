 ...
 * @returns {V} The modified reference vector
 */
function lerpX<V extends Object2D>(start: V, end: V, amount: number, referenceVector: V): V {
  referenceVector.x = lerpFn(start.x, end.x, amount)
  return referenceVector
}
 ...
 * @returns {V} The modified reference vector
 */
function lerpY<V extends Object2D>(start: V, end: V, amount: number, referenceVector: V): V {
  referenceVector.y = lerpFn(start.y, end.y, amount)
  return referenceVector
}

export { lerp as lerpObject }
export { lerpX as lerpObjectX }
export { lerpY as lerpObjectY }
